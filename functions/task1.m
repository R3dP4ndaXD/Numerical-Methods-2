...
function new_X = task1 (photo, k)
  ...
  %calculeaza new_X care este aproximarea matricei initiale photo,
  % folosind matricile calculate anterior.
  new_X = U * S * V';

  %transforma noua matrice in uint8 pentru a fi o imagine valida.
